...
from sleepy.utils.paths import compute_hash, scheme_cache_dir, wallpaper_thumbnail_path
...
def get_score_for_image(image: Path | str, cache_base: Path):
    ...
    from sleepy.utils.material.score import score
...
def get_colours_for_image(image: Path | str = wallpaper_thumbnail_path, scheme=None) -> dict[str, str]:
    if scheme is None:
        from sleepy.utils.scheme import get_scheme
    ...
    from sleepy.utils.material.generator import gen_scheme
