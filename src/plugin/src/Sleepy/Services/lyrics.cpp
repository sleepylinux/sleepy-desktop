...
Q_LOGGING_CATEGORY(lcLyrics, "sleepy.lyrics", QtInfoMsg)
...
[[nodiscard]] const QHash<QByteArray, QByteArray>& lrclibHeaders() {
    static const QHash<QByteArray, QByteArray> h = {
        { "User-Agent"_ba, "sleepy-shell (https://github.com/sleepy-dots/shell)"_ba },
    };
    return h;
}
...
const QString& Lyrics::stateDir() {
    static const QString s_dir = [] {
        ...
        return state + u"/sleepy/lyrics"_s;
    }();
    return s_dir;
}
...
const QString& Lyrics::cacheDir() {
    static const QString s_dir = [] {
        ...
        return cache + u"/sleepy/lyrics"_s;
    }();
    return s_dir;
}
