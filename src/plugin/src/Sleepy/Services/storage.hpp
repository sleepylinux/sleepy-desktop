...
class Storage : public TickingService {
    ...
    Q_PROPERTY(QQmlListProperty<sleepy::services::DiskInfo> disks READ disksProp NOTIFY disksChanged)
    Q_PROPERTY(sleepy::services::DiskInfo* manualPrimaryDisk READ manualPrimaryDisk WRITE setManualPrimaryDisk NOTIFY
            manualPrimaryDiskChanged)
    Q_PROPERTY(sleepy::services::DiskInfo* primaryDisk READ primaryDisk NOTIFY primaryDiskChanged)
