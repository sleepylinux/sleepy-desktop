...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(sleepy::config::LyricsBackend::Enum backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(sleepy::config::LyricsBackend::Enum preferredBackend READ preferredBackend WRITE setPreferredBackend
            NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<sleepy::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(sleepy::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
