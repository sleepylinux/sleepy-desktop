...
namespace sleepy::components {

class SparklineItem : public QQuickPaintedItem {
    Q_OBJECT
    QML_ELEMENT

    Q_PROPERTY(sleepy::CircularBuffer* line1 READ line1 WRITE setLine1 NOTIFY line1Changed)
    Q_PROPERTY(sleepy::CircularBuffer* line2 READ line2 WRITE setLine2 NOTIFY line2Changed)
