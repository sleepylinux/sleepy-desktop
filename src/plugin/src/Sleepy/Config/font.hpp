...
class FontBuilders : public QObject {
    ...
    Q_PROPERTY(sleepy::config::FontBuilder large READ large NOTIFY buildersChanged FINAL)
    Q_PROPERTY(sleepy::config::FontBuilder medium READ medium NOTIFY buildersChanged FINAL)
    Q_PROPERTY(sleepy::config::FontBuilder small READ small NOTIFY buildersChanged FINAL)
...
class IconFontBuilders : public FontBuilders {
    ...
    Q_PROPERTY(sleepy::config::FontBuilder extraLarge READ extraLarge NOTIFY buildersChanged FINAL)
...
class FontStyle : public FontStyleBase {
    ...
    Q_PROPERTY(sleepy::config::FontBuilders* builders READ builders CONSTANT FINAL)
...
class IconFontStyle : public FontStyleBase {
    ...
    Q_PROPERTY(sleepy::config::IconFontBuilders* builders READ builders CONSTANT FINAL)
...
class FontTokens : public QObject {
    ...
    Q_PROPERTY(sleepy::config::FontStyle* headline READ headline CONSTANT FINAL)
    Q_PROPERTY(sleepy::config::FontStyle* title READ title CONSTANT FINAL)
    Q_PROPERTY(sleepy::config::FontStyle* body READ body CONSTANT FINAL)
    Q_PROPERTY(sleepy::config::FontStyle* label READ label CONSTANT FINAL)
    Q_PROPERTY(sleepy::config::FontStyle* mono READ mono CONSTANT FINAL)
    Q_PROPERTY(sleepy::config::IconFontStyle* icon READ icon CONSTANT FINAL)
    Q_PROPERTY(sleepy::config::FontBuilder clock READ clock NOTIFY clockChanged FINAL)
