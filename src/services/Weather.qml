...
// Modified for Sleepy: product identity only; provider behavior matches upstream.
...
Singleton {
    ...
    readonly property bool available: cc !== null && city.length > 0
    readonly property bool busy: ipApiRequestPending
    ...
    function fetchCityFromCoords(coords: string): void {
        ...
        const nominatimHeaders = {
            "User-Agent": `sleepy-shell/${CUtils.version}`
        };
    ...
    LoggingCategory {
        ...
        name: "sleepy.qml.services.weather"
