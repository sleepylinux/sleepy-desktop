...
bash "$repo_root/tests/selection-capture-contract.sh"
bash "$repo_root/tests/capture-writer.sh"
bash "$repo_root/tests/capture-client-process.sh"
bash "$repo_root/tests/appearance-cli.sh"
